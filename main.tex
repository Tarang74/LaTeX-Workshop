...
\begin{outputbox}
    We define the array: \mintinline{tex}|int[] array = { 1, 2, 3 }|.
\end{outputbox}
Here we can use the same symbol to delineate the arguments inside the macro. In this case, we use pipes (\mintinline{tex}{|}), but we can use any symbol apart from the percentage sign (\mintinline{tex}{%}), i.e.,
